...
namespace NathanAldenSr.VorpalEngine.Common.Windows
{
    ...
    public class Monitor : IEquatable<Monitor>
    {
        ...
        /// <summary>
        ///     Gets a <see cref="Rectangle{T}" /> representing the working area of the monitor's display area. Working area excludes the
        ///     Windows taskbar.
        /// </summary>
        ...
        /// <inheritdoc />
        public bool Equals(Monitor? other) => this == other;
        ...
        public static Monitor From(Vector2<int> vector)
        {
        ...
        /// <summary>Creates a <see cref="Monitor" /> from a <see cref="Vector2{T}" />.</summary>
        ...
        public static Monitor From(HWND windowHandle) => new(MonitorFromWindow(windowHandle, MONITOR_DEFAULTTONEAREST));
        ...
        /// <returns>
        ///     A <see cref="Rectangle{T}" /> representing the working area of the monitor containing
        ///     <paramref name="vector" />, defaulting to the nearest monitor.
        /// </returns>
        public static Rectangle<int> GetWorkingArea(Vector2<int> vector) => From(vector).WorkingArea;
        ...
        /// <returns>
        ///     A <see cref="Rectangle{T}" /> representing the working area of the monitor containing
        ///     <paramref name="rectangle" />, defaulting to the nearest monitor.
        /// </returns>
        public static Rectangle<int> GetWorkingArea(Rectangle<int> rectangle) => From(rectangle).WorkingArea;
        ...
        /// <returns>
        ///     A <see cref="Rectangle{T}" /> representing the bounds of the monitor containing
        ///     <paramref name="vector" />, defaulting to the nearest monitor.
        /// </returns>
        public static Rectangle<int> GetBounds(Vector2<int> vector) => From(vector).Bounds;
        ...
        ///     <paramref name="rectangle" />, defaulting to the nearest monitor.
        /// </returns>
        public static Rectangle<int> GetBounds(Rectangle<int> rectangle) => From(rectangle).Bounds;

        /// <inheritdoc />
        public override bool Equals(object? obj) => obj is Monitor monitor && this == monitor;

        /// <inheritdoc />
        public override int GetHashCode() => HashCode.Combine(MonitorHandle);
        ...
        ///     <see langword="false" />.
        /// </returns>
        public static bool operator ==(Monitor? left, Monitor? right) => left?.MonitorHandle == right?.MonitorHandle;
