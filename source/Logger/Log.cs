...
namespace NathanAldenSr.VorpalEngine.Logging
{
    ...
    public static class Log
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Verbose(string? messageTemplate = null, params object?[] propertyValues) => Logger?.Verbose(messageTemplate, propertyValues);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Debug(string? messageTemplate = null, params object?[] propertyValues) => Logger?.Debug(messageTemplate, propertyValues);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Information(string? messageTemplate = null, params object?[] propertyValues) => Logger?.Information(messageTemplate, propertyValues);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Warning(string? messageTemplate = null, params object?[] propertyValues) => Logger?.Warning(messageTemplate, propertyValues);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Error(string? messageTemplate = null, params object?[] propertyValues) => Logger?.Error(messageTemplate, propertyValues);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Fatal(string? messageTemplate = null, params object?[] propertyValues) => Logger?.Fatal(messageTemplate, propertyValues);
    }
}