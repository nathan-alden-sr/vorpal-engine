...
namespace NathanAldenSr.VorpalEngine.Engine.Configuration
{
    ...
    public abstract class Configuration
    {
        ...
        ///     temporary.
        /// </returns>
        public Input Input(bool initialize = false) => initialize ? _Input ??= new Input() : _Input ?? new Input();
        ...
        ///     temporary.
        /// </returns>
        public Logging Logging(bool initialize = false) => initialize ? _Logging ??= new Logging() : _Logging ?? new Logging();
        ...
        /// </returns>
        public MessageQueue MessageQueue(bool initialize = false) => initialize ? _MessageQueue ??= new MessageQueue() : _MessageQueue ?? new MessageQueue();
        ...
        ///     temporary.
        /// </returns>
        public Windows Windows(bool initialize = false) => initialize ? _Windows ??= new Windows() : _Windows ?? new Windows();
    }
}