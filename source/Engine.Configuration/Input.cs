...
public sealed class Input
{
    ...
    /// </returns>
    public InputKeyboard Keyboard(bool initialize = false)
        => initialize ? _Keyboard ??= new InputKeyboard() : _Keyboard ?? new InputKeyboard();
    ...
    ///     temporary.
    /// </returns>
    public InputMouse Mouse(bool initialize = false)
        => initialize ? _Mouse ??= new InputMouse() : _Mouse ?? new InputMouse();
