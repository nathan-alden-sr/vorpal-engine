        ...
        private static unsafe void Main()
        {
            ...
            fixed (char* pTitle = title)
            {
                ...
                ThrowExternalExceptionIfZero(
                    classAtom = RegisterClassExW(&wndClassExW),
                        ...
                        foreach (uint index in _hidControllerManager.StateChangeIndexes)
                        {
                            ...
                            if (controller is not null)
                            {
                                ...
                                if (isStateValid)
                                {
                                    ...
                                    {
                                        int width = (int)column.ExtendedProperties["Width"]!;
        ...
        private static unsafe nint WindowProc(IntPtr hWnd, uint uMsg, nuint wParam, nint lParam)
        {
            switch (uMsg)
            {
                ...
                case WM_INPUT:
                    ...
                    {
                        ThrowExternalException(getRawInputBufferData, nameof(GetRawInputBuffer));
                    }
